...
const createUsers = () => {
    ...
    return [
        ...
        { username: 'admin', password: 'admin', email: "admim@olearning.com", firstname: "Admin", lastname: "Admin" ,usertype: "2" },
    ]
}
...
const initDatabase =  async () => {
    ...
    //service.addCourseToUser(users[0]._id, courses[0])
    //service.addUserToCourse(courses[0]._id, users[0])

    //const comments = await Comment.find()
    //service.addCommentToUser(users[0]._id, comments[0])
    //service.addUserToComment(comments[0]._id, users[0]) 
